...
- **[component-data-refactor](./skills/engineering/component-data-refactor/SKILL.md)** — Review a focused React or React Native refactor, sketch data flow and component tree, then wait for approval before coding.
