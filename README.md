...
- **[codex-manager](./skills/engineering/codex-manager/SKILL.md)** — Coordinate complex Codex engineering tasks with specialist agents, validation gates, PR handling, and final independent audits.
